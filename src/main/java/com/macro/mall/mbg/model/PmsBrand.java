...
public class PmsBrand implements Serializable {
    ...
    @ApiModelProperty(value = "Chữ cái đầu")
    ...
    @ApiModelProperty(value = "Cho dù đó là nhà sản xuất thương hiệu: 0-> không; 1-> có")
    @JsonProperty("factory_status")
    private Integer factoryStatus;

    @ApiModelProperty(value = "Có hiển thị hay không")
    ...
    @ApiModelProperty(value = "Đánh giá sản phẩm")
    @JsonProperty("product_comment_count")
    private Integer productCommentCount;

    @ApiModelProperty(value = "Logo thương hiệu")
    @JsonProperty("logo")
    private String logo;

    @ApiModelProperty(value = "Khu vực hình ảnh lớn")
    @JsonProperty("big_pic")
    private String bigPic;

    @ApiModelProperty(value = "Câu chuyện thương hiệu")
